...
export function Proof() {
  ...
  return (
    <section id="how" className="pt-16 pb-24 sm:pb-32">
        ...
        <div className="mx-auto w-full max-w-6xl">
          ...
          <div className="mt-14 grid gap-10 lg:grid-cols-2 lg:gap-12">
            ...
            <article className="min-w-0">
              ...
              <p className="mt-4 max-w-md leading-relaxed text-muted">
                Simplifying a group down to the fewest payments is easy. Explaining the
                result is the part nobody does, so people end up owing money to someone they
              ...
              <div className="mt-8 overflow-hidden rounded-2xl border border-rule bg-paper-raised">
                ...
                <div className="px-6 py-6">
                  ...
                  <p className="mt-6 text-sm leading-relaxed text-muted">
                    {NAMES[transfer.to]} settles those on your behalf, so the group clears
                    in {transfers.length} payments instead of {edges.length}.
                  </p>
                </div>
              </div>
            </article>
